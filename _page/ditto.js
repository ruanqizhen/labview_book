...
var utterancCode = '<h3>留言</h3><script src="https://utteranc.es/client.js" repo="ruanqizhen/labview_book" issue-term="pathname" label="comment" theme="github-light" crossorigin="anonymous" async></script></div>';
var menu = new Array();
...
function init_searchbar() {
  var search = '<form class="searchBox" onSubmit="return searchbar_listener()">' +
    ...
    '<input type="image" class="searchButton" src="_page/magnifier.jpg" alt="Search" />' +
    '</form>';
