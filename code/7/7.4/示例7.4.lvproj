...
<Project Type="Project" LVVersion="8608001">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="时间坐标.vi" Type="VI" URL="../时间坐标.vi"/>
		<Item Name="波形属性.vi" Type="VI" URL="../波形属性.vi"/>
		<Item Name="同一坐标轴.vi" Type="VI" URL="../同一坐标轴.vi"/>
		<Item Name="不同坐标轴.vi" Type="VI" URL="../不同坐标轴.vi"/>
		<Item Name="中断的曲线.vi" Type="VI" URL="../中断的曲线.vi"/>
		<Item Name="声卡示波器.vi" Type="VI" URL="../声卡示波器.vi"/>
		<Item Name="声卡信号发生器.vi" Type="VI" URL="../声卡信号发生器.vi"/>
		<Item Name="信号发生加示波器.vi" Type="VI" URL="../信号发生加示波器.vi"/>
		<Item Name="时频联合分析.vi" Type="VI" URL="../时频联合分析.vi"/>
		<Item Name="声卡时频联合分析.vi" Type="VI" URL="../声卡时频联合分析.vi"/>
		<Item Name="高级时频联合分析.vi" Type="VI" URL="../高级时频联合分析.vi"/>
		<Item Name="依赖关系" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="TFA Choose Data Source For Express VIs.vi" Type="VI" URL="/&lt;vilib&gt;/addons/Time Frequency Analysis/Utilities.llb/TFA Choose Data Source For Express VIs.vi"/>
				<Item Name="Get Input.vi" Type="VI" URL="/&lt;vilib&gt;/Addons/Time Frequency Analysis/_express/TimeFrequencySpectrogramSource.llb/Get Input.vi"/>
				<Item Name="subTimeFrequencySpectrogram.vi" Type="VI" URL="/&lt;vilib&gt;/addons/Time Frequency Analysis/_express/TimeFrequencySpectrogramSource.llb/subTimeFrequencySpectrogram.vi"/>
